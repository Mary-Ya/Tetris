(function(w, d) {
    ...
    pluso.lang["ru"] = {
        close: "ааАаКбббб",
        get: "ааНаОаПаКаИ баВаЕаЛаИбаИаВаАбб ббаАбаИаК",
        share: "ааОаДаЕаЛаИбаЕбб б аДббаЗббаМаИ!",
        bookmark: "аЁаКаОаПаИббаЙбаЕ аИ аДаОаБаАаВббаЕ ббб бббаЛаКб аВ ааАаКаЛаАаДаКаИ",
        buy: "абаПаИбб"
    };
    pluso.lang["ua"] = {
        close: "ааАаКбаИбаИ",
        get: "аббаИаМаАббаЕ баВаОб аКаНаОаПаКаИ",
        share: "ааОаДбаЛаИбаЕбб аЗ аДббаЗбаМаИ!",
        bookmark: "аЁаКаОаПббаЙбаЕ баА аДаОаДаАаЙбаЕ бб аПаОбаИаЛаАаНаНб аВ ааАаКаЛаАаДаКаИ",
        buy: "абаПаИбаИ"
    };
    pluso.lang["by"] = {
        close: "ааАббаНббб",
        get: "абббаМаАаЕбаЕ баВаАаЕ аКаНаОаПаКб",
        share: "ааАаДаЗбаЛббаЕбб аЗ ббаБбаАаМб!",
        bookmark: "аЁаКаАаПббаЙбаЕ б аДаАаДаАаЙбаЕ аГбббб баПаАббаЛаКб б ааАаКаЛаАаДаКб",
        buy: "абаПббб"
    };
    pluso.lang["en"] = {
        close: "Close",
    ...
    pluso.titles = [
        ["vkontakte", "аааОаНбаАаКбаЕ", 5, 3, "#41658b"],
        ["odnoklassniki", "ааДаНаОаКаЛаАббаНаИаКаИ", 4, 4, "#f4960f"],
        ["facebook", "Facebook", 1, 1, "#39579a"],
        ["twitter", "Twitter", 2, 2, "#00abf0"],
        ["google", "Google+", 7, 5, "#be3308"],
        ["moimir", "ааОаЙ ааИб@Mail.Ru", 8, 7, "#2f69a1"],
        ...
        ["bobrdobr", "ааОаБбааОаБб", 18, 24, "#763c34"],
        ...
        ["vkrugu", "а аббаГб аббаЗаЕаЙ", 25, 25, "#e95e12"],
        ["pinme", "Pinme", 27, 16, "#f47a24"],
        ["yandex", "аЏ.бб", 28, 23, "#e70505"],
        ["yazakladki", "аЏаНаДаЕаКб.ааАаКаЛаАаДаКаИ", 29, 29, "#ff0000"],
        ["moikrug", "ааОаЙаббаГ", 30, 30, "#c71b1a"],
        ["googlebookmark", "Google аЗаАаКаЛаАаДаКаИ", 31, 31, "#0e41f4"],
        ["yahoo", "Yahoo аЗаАаКаЛаАаДаКаИ", 32, 32, "#7b0099"],
        ["moemesto", "ааОбааЕббаО", 33, 33, "#3a5d82"],
        ["memori", "Memori.ru", 34, 34, "#fd2668"],
        ["juick", "Juick", 36, 35, "#b98337"],
        ["linkedin", "LinkedIn", 37, 36, "#0072ab"],
        ["webdiscover", "WebDiscover", 39, 37, "#8bc514"],
        ["bookmark", "а аЗаАаКаЛаАаДаКаИ", 22, 26, "#de157d"],
        ["email", "абаПбаАаВаИбб аНаА email", 23, 27, "#5f32b0"],
        ["print", "ааЕбаАбаАбб", 24, 28, "#0fae96"],
        ["webmoney", "Webmoney баОаБббаИб", 45, 39, "#007dc6"],
        ["misterwong", "ааИббаЕб ааОаНаГ", 44, 40, "#ab0315"],
        ["friendfeed", "Friend Feed", 43, 41, "#5e92d1"],
        ["market", "Pluso ааАбаКаЕб", false, 38]
    ];
    pluso.buy = ["cart", "dollar", "bulb", "quest", "tag"];
    pluso.tips = [
        ["а аАбаПбаОаДаАаЖаА!", "а­баО аМаОаЖаЕб аБббб ааАаМ аИаНбаЕбаЕбаНаО!", "абббаИаЕ баОаВаАбб баО баКаИаДаКаОаЙ!", "аЁаПаЕбаПбаЕаДаЛаОаЖаЕаНаИб аОб аИаНбаЕбаНаЕб-аМаАаГаАаЗаИаНаОаВ!", "аЁаАаМбаЕ аПбаОаДаАаВаАаЕаМбаЕ баОаВаАбб!", "абаБбаЕ баОаВаАбб аПаО аЛбббаИаМ баЕаНаАаМ!", "ааОаПбаЛббаНбаЕ баОаВаАбб аПаО аЛбббаИаМ баЕаНаАаМ!", "ааОаПбаЛббаНбаЕ баОаВаАбб баО баКаИаДаКаОаЙ!", "аЂаОаВаАбб аДаЛб аКаОаМбаОббаНаОаЙ аЖаИаЗаНаИ баО баКаИаДаКаОаЙ!", "аЁаАаМбаЕ аВаОбббаЕаБаОаВаАаНаНбаЕ баОаВаАбб баО баКаИаДаКаОаЙ!", "ааОаВаИаНаКаИ аОб аИаНбаЕбаНаЕб-аМаАаГаАаЗаИаНаОаВ!", "абббаИаЕ баЕаНб аОб аИаНбаЕбаНаЕб-аМаАаГаАаЗаИаНаОаВ!", "ааЕбббаЕаЛаЛаЕбб аОб аИаНбаЕбаНаЕб-аМаАаГаАаЗаИаНаОаВ!", "ааЕбббаЕаЛаЛаЕбб аПаО аЛбббаИаМ баЕаНаАаМ!", "ааОаВаИаНаКаИ аПаО аЛбббаИаМ баЕаНаАаМ!"], {
            big: {
        ...
        return function(e) {
            ...
            if (t.tagName == "A") {
                if (t.className.substr(0, 12) == "pluso-market") {
                    ...
                    html = [];
                    html.push('<div><a target="_blank" href="//market.pluso.ru?newmarket" style="margin:0 0 0 20px;padding:0;text-decoration:none"><img src="' + u + '/img/pluso-like/logo-market.png" border="0" width="300" height="30" alt="Pluso ааАбаКаЕб"></a><a target="_blank" href="//market.pluso.ru/" style="float:right;margin:3px 20px 0 0;text-align:right;font:bold normal 20px/26px Arial;text-decoration:none;color:#848484;width:550px">абббаИаЕ баОаВаАбб аПаО баАаМбаМ аВбаГаОаДаНбаМ баЕаНаАаМ!</a></div>');
    ...
    pluso.share_bookmark = function(ep) {
        ...
        } else prompt("аЁаКаОаПаИббаЙбаЕ аИ аДаОаБаАаВббаЕ ббб бббаЛаКб аВ ааАаКаЛаАаДаКаИ", ep.params.url)
    };
    ...
    pluso.market = function(items) {
        ...
        for (var i = 0, l = items.length; i < l; i++) {
            var it = items[i];
            html.push('<li><a href="' + it.url + '" target="_blank"><span><img src="//offers.pluso.ru/img/' + it.image + '.png" border="0" alt="" height="150"></span><strong>' + it.title + "</strong><em>" + (it.price * 1).toString() + " ббаБ.<u>ааЗ ббаК аВ ббаКаИ</u></em><b>абаПаИбб!</b></a></li>")
        }
